...
public class NavigatorAdapter extends CommonNavigatorAdapter {
  ...
  public NavigatorAdapter(String[] labels, ViewPager vp) {
    this.labels = labels;
    this.vp = vp;
  }
  ...
  public IPagerTitleView getTitleView(Context context, int index) {
    ...
    float width = context.getResources().getDimension(R.dimen.w_quotations_magic_indicator);
    pagerTitleView.setMinimumWidth((int) width);
