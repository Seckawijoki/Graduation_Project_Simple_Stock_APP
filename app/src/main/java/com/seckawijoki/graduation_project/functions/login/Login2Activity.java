...
public class Login2Activity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mEmailView = (AutoCompleteTextView) findViewById(R.id.actv_login_phone_or_email);
    populateAutoComplete();

    mPasswordView = (EditText) findViewById(R.id.actv_login_password);
    ...
    mLoginFormView = findViewById(R.id.sv_login);
    mProgressView = findViewById(R.id.pb_login);

//    findViewById(R.id.btn_debug_sign_in).performClick();
  }
